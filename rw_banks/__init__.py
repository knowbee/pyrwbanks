banks = [
  {
    ...
    "bank_code": "ABBR",
    "postal_code": "671",
    "address": "15 KN 78 St, Kigali, Rwanda",
    "phone_number": "+250782298060",
    "toll_free": None,
    "email_address": "support@abbank.rw",
    "ussd_code": None
  },
  {
  ...
  },
  {
    ...
    "swift_code": "BNRWRWRP",
    "bank_code": "BNRW",
    "address": "4 KN 6 Ave, Kigali, Rwanda",
    "postal_code": "531",
    "phone_number": "+250788199000",
    "toll_free": None,
    "email_address": "info@bnr.rw",
    "ussd_code": None
  },
  {
  ...
  },
  {
    ...
    "swift_code": "CGBKRWRW",
    "bank_code": "CGBK",
    "address": "KN 63 St, Kigali, Rwanda",
    "postal_code": "5230",
    "phone_number": "+25078815500",
    "toll_free": "5050",
  ...
  },
  {
    ...
    "postal_code": None,
    "phone_number": "+250788161000",
    "toll_free": None,
    "email_address": "ecobankenquiries@ecobank.com",
    "ussd_code": None
  },
  {
    "name": "EQUITY BANK RWANDA LIMITED",
    "swift_code": "EQBLRWRW",
    "bank_code": "EQBL",
    "address": "Grand Pension Plaza, 1st Floor, KN 4 Ave, Kigali, Rwanda",
    "postal_code": "494",
  ...
  },
  {
    ...
    "swift_code": "KCBLRWRW",
    "bank_code": "KCBL",
    "address": "18 KN 4 Ave, Kigali, Rwanda",
    "postal_code": "5620",
    "phone_number": "+250788140400",
    "toll_free": None,
  ...
  },
  {
    ...
    "postal_code": "748",
    "phone_number": "+250788173100",
    "toll_free": "5151",
    "email_address": "info@urwegobank.com",
    "ussd_code": "*501#"
  },
  {
    "name": "ZIGAMA CSS",
...
def getBanks():
  """ Method to return all licensed banks from Rwanda """
  return banks

def getBank(swift_code):
  
  """Method to retreive a licensed bank by swift code.

    Args:
        swift_code: pass in the swift code in the function to return a bank with that swift code
    """
  if swift_code:
    try:
        bank = [bank for bank in banks if bank["swift_code"] == swift_code]
        return bank[0]
    except IndexError:
        return None
